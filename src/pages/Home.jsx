...
import {FiMessageSquare, FiFolder, FiShoppingCart, FiSettings} from "react-icons/fi"
        ...
        <div className="mt-4 flex flex-col gap-4 relative">
         {
          menus?.map((menu, index) => {
            return (
              ...
              group flex items-center text-sm gap-3.5 
              font-medium p-2 hover:bg-gray-800 rounded-md`}>
                ...
                className={`whitespace-pre duration-500 ${!open && 
                  'opacity-0 translate-x-28 overflow-hidden'}`}>{menu.name}
                </h2>
